...
int main() {
	...
	//Display Results
	//Temporary display for testing, not final
...
//Returns true if the userQueue is valid for turning into postfix
...
//Returns an int depending on the precedence of an operator
...
//Changes the infix userQueue into postfix form
...
double evaluatePostfix(Queue<char>&postfixQueue, Stack<double>& calculatingStack) {
	...
	*/
	...
	calculatingStack.pop(finalAnswer);
